import {Http, BaseRequestOptions, Response, ResponseOptions, XHRBackend, RequestOptions, RequestMethod} from '@angular/http';
 import { MockBackend, MockConnection } from '@angular/http/testing';

export function fakeBackendFactory(backend: MockBackend, options: BaseRequestOptions, realBackend: XHRBackend) {
    // array in local storage for registered users
    const users: any[] = JSON.parse(sessionStorage.getItem('users')) || [];
    const days: any[] =  [{'day' : '15/09/2017' , 'type' : '0'} , {'day' : '16/09/2017' , 'type' : '0'} , {'day' : '17/09/2017' , 'type' : '0'}];
    ...
    backend.connections.subscribe((connection: MockConnection) => {
        ...
        setTimeout(() => {
            ...
            // get users
            if (connection.request.url.endsWith('/leave/days!') && connection.request.method === RequestMethod.Get) {
